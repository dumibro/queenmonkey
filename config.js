...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './queenmonkey.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'queenmonkey 1.0 beta version',
    CHANNEL: 'https://chat.whatsapp.com/HbURDOKU6Up29kmFXZUMEo',
    SESSION: process.env.KINGDUMI_SESSION === undefined ? '' : process.env.KINGDUMI_SESSION,
    ...
    DATABASE: DATABASE_URL === './queenmonkey.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
